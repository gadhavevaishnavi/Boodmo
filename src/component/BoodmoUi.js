  ...
  return (
    <section className="bg-sky-300 py-12 px-6 flex flex-col md:flex-row items-center justify-between gap-8">
      ...
      <div className="flex flex-col gap-4 w-full md:w-1/2">
        ...
        <button className="bg-blue-900 text-xl text-white flex items-center justify-center gap-3 px-5 py-5 rounded-lg shadow-md hover:bg-blue-700 transition w-1/2">
